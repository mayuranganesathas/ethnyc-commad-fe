...
const DataTable = ({}: DataTableProps) => {
  ...
  const columnDefs: GridColDef[] = [
    { field: "id", headerName: "Wallet Address", flex: 0 },
    { field: "name", headerName: "Total Posts", flex: 1 },
    { field: "dao", headerName: "Average Shares", flex: 0 },
    { field: "maturityDate", headerName: "Average Comments", flex: 0 },
    { field: "addr", headerName: "Virality Score", flex: 1 },
    {
      field: "Description",
      flex: 0.5,
